...
urlpatterns = [
    ...
    path('edit-menu-item/<int:item_id>/', views.edit_menu_item, name='edit-menu-item'),
    path('delete-menu-item/<int:item_id>/', views.delete_menu_item, name='delete-menu-item'),
