...
POSTGRES_URL = 'postgresql://tengo_user:Cx5Bxuxpwi3xSGLe84TcOe15tk5qfSB9@dpg-cv52c9dds78s73ctnk10-a/tengo' #need to work on environment variablesYea
from redis import Redis

print(f"Connecting to Redis at: {POSTGRES_URL}")

try:
    redis = Redis.from_url(POSTGRES_URL)
    redis.ping()
